            ...
            (taskContent, task) => {
                taskContent += `
                    <li>
                        ...
                        <div class="buttons">
                            <button class="remove" data-task-id="${task.id}"  data-task-status="${task.status}" onclick="deleteTask(event)">
                                <i class="fa fa-trash-alt"></i>
                                </button>
                            <button class="complete" data-task-id="${task.id}"  data-task-status="${task.status}" onclick="updateStatusTask(event)" >
